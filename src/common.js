...
require('./images/first-quadrant-btn-bg-dark.svg')
require('./images/second-quadrant-btn-bg-dark.svg')
require('./images/third-quadrant-btn-bg-dark.svg')
require('./images/fourth-quadrant-btn-bg-dark.svg')
require('./images/arrow-white-icon.svg')
require('./images/search-active-wave.svg')
require('./images/pdf_banner.png')
require('./images/joellelogo.png')
